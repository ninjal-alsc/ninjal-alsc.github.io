...
テーマは「**次世代の言語理論を考える**」です。言語モデルの台頭により、言語学・言語理論の妥当性について賛否様々な主張が沸き起こっています。このテーマはもちろん簡単に答えが出る類のものではありません。言語学者と自然言語処理の研究者が集まって議論することで、前提としている考え方の違いを明らかにし、隠れている共通点を見つけ出し、言語学の未来を考える機会となればと思っています。
...
- **アンチハラスメントポリシー**
  ...
  - 建設的で刺激的な学際的議論を実現するためには、様々な専門性を持った人が集まり、お互いの分野の価値観やディシプリンに敬意を払い、そして学ぶ必要があります。他分野に対するネガティブな価値判断をおこなわないなど、学術的に誠実な心構えでのご参加をお願いします。
